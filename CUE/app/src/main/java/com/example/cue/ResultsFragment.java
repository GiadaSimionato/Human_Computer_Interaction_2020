...
public class ResultsFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        eds=view.findViewById(R.id.button);
        eds.setVisibility(View.INVISIBLE);
        title=view.findViewById(R.id.textView9);
        title.setText("My Results!");


        initData();
        initRecyclerView();
        String message = " course saved in "+ courseList.size() +" for Engineering in Computer Science course";
        ...
        private void initData() {
            ...
            /*SearchResFragment f= new SearchResFragment();

            List<Course> lista=f.getCl();


            for(int i=0; i<lista.size(); i++){
                if (lista.get(i).isSaved()== true){
                    courseList.add(lista.get(i));
                }
            }*/
            // [EDIT]
